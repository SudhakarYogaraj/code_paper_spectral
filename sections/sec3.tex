...
Making precise sense of equations \eqref{eq: basis spde1}, \eqref{eq: basis spde2} requires a detailed study
...
\begin{equation*} 
    \left\{\begin{aligned}
        ...
        \end{aligned} \right.  
\end{equation*} 
This system of equations is infinite dimensional, and so it can't be integrated
