...
vec Solver_spectral::discretize(vec x, Gaussian_integrator& gauss, double(*f)(vec, vec )) {
...
vec Solver_spectral::project_mon(int nf, int degree, const Gaussian_integrator& gauss, vec f_discretized, int rescale) {
...
vec Solver_spectral::project_herm(int nf, int degree, const Gaussian_integrator& gauss, vec f_discretized, int rescale) {
